...
docker run --rm -v /var/data/mapdata/:/var/app/source/ -v /var/services/vector-tiles-api/data/cyclenetworks-test/:/var/app/tiles/ anywaysopen/vector-tiles-generator:latest
